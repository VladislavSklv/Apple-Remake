...
import { animateWithGsap } from "../utils/anims";
...
const Features = () => {
  ...
  return (
    <section className="h-full bg-zinc common-padding relative overflow-hidden">
      <div className="screen-max-width">
        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
          <div className="md:mt-32 md:mb-24 mt-10 mb-12 self-start pl-24">
            ...
            <div className="flex flex-col w-full relative">
              ...
              <div className="feature-text-container">
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text w-[98%]">
                    iPhone 15 Pro is{" "}
